Este repositorio incluye scripts divididos en las siguientes categorias:
- Estudios_escogidos: depuración de indices para su empleo en el script de descarga de datos genomicos desde la plataforma ENA
- Gluten_metabolomica: Script para la detección de gluten en datos obtenidos de MEDI y comparación estadistica
